...
pub fn schema_types_test() {
  ...
  let string_schema =
    json_schema.Type(nullable: False, metadata: [], type_: json_schema.String)
  let number_schema =
    json_schema.Type(nullable: False, metadata: [], type_: json_schema.Number)
...
pub fn enum_schema_test() {
  let enum_schema =
    json_schema.Enum(nullable: False, metadata: [], variants: [
      "red", "green", "blue",
    ])
...
pub fn array_schema_test() {
  let item_schema =
    json_schema.Type(nullable: False, metadata: [], type_: json_schema.String)
  let array_schema =
    json_schema.Array(nullable: False, metadata: [], items: item_schema)
...
pub fn codegen_generator_test() {
  ...
  let _gen_with_decoders =
    json_schema.generate_decoders(gen_with_encoders, True)
...
pub fn nullable_schema_test() {
  let nullable_string =
    json_schema.Type(nullable: True, metadata: [], type_: json_schema.String)

  let non_nullable_string =
    json_schema.Type(nullable: False, metadata: [], type_: json_schema.String)
